...
public class MonkeyLearnClient {
    ...
    private static final String AUTH_TOKEN = "b24793e6ac513eeb946b90ffac52adf1c6cbcd00";

    public List<Set<String>> extract(List<String> articles) {
        ObjectMapper mapper = new ObjectMapper();
        CloseableHttpClient httpClient = HttpClients.createDefault();

        //set httpPost request
        ...
        // set the request Entity. ?? why not setBody cuz header is already set
        try {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("keywords extracred: " +  keywords);
